#ifndef LOCALCUSTOMCOMMANDINVOKER_H
#define LOCALCUSTOMCOMMANDINVOKER_H
...
class LocalCustomCommandInvoker: public ICommandInvoker
{
public:
...
#endif // LOCALCUSTOMCOMMANDINVOKER_H
